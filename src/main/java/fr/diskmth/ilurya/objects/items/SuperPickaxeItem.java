...
public class SuperPickaxeItem extends ItemPickaxe implements IHasModel
{
    private String typeOfSpuerPickaxe = "";

    public SuperPickaxeItem(String name, ToolMaterial material)
    {
        super(material);
    ...
    {
        if(typeOfSpuerPickaxe.contains("colaria") && repair.getItem() == ItemsInit.COLARIA)
        {
            return true;
        }
