package fr.diskmth.ilurya.client.gui;
...
public class GuiCustomMainMenu extends GuiScreen
{
    ...
    private static final ResourceLocation LOGO = new ResourceLocation(References.MODID + ":textures/logo/logo.png");
    ...
    public void initGui()
    {
        ...
        this.widthCopyright = this.fontRenderer.getStringWidth("Ilurya n'est en aucun cas affilie a Mojang AB ");
    ...
    protected void actionPerformed(GuiButton button) throws IOException
    {
        ...
        if(button.id == 2)
        {
            FMLClientHandler.instance().connectToServer(this, new ServerData("ilurya", "play.ilurya.fr:25565", false));
        }
    ...
    public void drawScreen(int mouseX, int mouseY, float partialTicks)
    {
        ...
        GlStateManager.popMatrix();
        this.drawString(this.fontRenderer, "Ilurya n'est en aucun cas affilie a Mojang AB", this.widthCopyrightRest, this.height - 10, -1);
